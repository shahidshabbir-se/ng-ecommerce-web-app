...
const Bar = () => {
  ...
  return (
    <div className='flex flex-col'>
      <div className='left-0 top-[30px] flex h-12 w-screen items-center gap-2 overflow-hidden overflow-x-hidden bg-[#0e3cf6] lg:absolute lg:order-2 lg:h-[calc(100vh-30px)] lg:w-[200px] lg:flex-col lg:items-start lg:bg-transparent lg:p-5'>
        ...
        <div className='flex w-full text-white lg:flex-col lg:rounded-[5px] lg:bg-white lg:text-[#969696] lg:dark:bg-dark-bg'>
          <button className='ml-[10px] flex flex-grow items-center gap-2 lg:ml-0 lg:justify-between lg:border-b lg:border-[##969696] lg:p-4'>
          ...
          <div className='flex items-center pr-4 text-white lg:flex-col lg:justify-center lg:gap-[5px] lg:p-4 lg:text-black lg:dark:text-white'>
            ...
            >
              <span className='invisible hidden size-1.5 animate-pulse rounded-full bg-black transition-all duration-300 ease-in-out group-hover:visible lg:block' />
              <span className='hidden lg:block lg:-translate-x-6 lg:transform lg:transition-all lg:duration-500 lg:ease-in-out lg:group-hover:-translate-x-2'>
                Account
              </span>
              <icons.user className='h-4 w-8 stroke-[8px]' />
            </Link>
            <Link
              href='/cart'
              className='group flex items-center justify-between lg:w-full'
            >
              <span className='invisible hidden size-1.5 animate-pulse rounded-full bg-black transition-all duration-300 ease-in-out group-hover:visible lg:block' />
              <span className='hidden lg:block lg:-translate-x-9 lg:transform lg:transition-all lg:duration-500 lg:ease-in-out lg:group-hover:-translate-x-5'>
                Cart
              </span>
              <icons.cart className='h-4 w-8 stroke-[8px]' />
            </Link>
